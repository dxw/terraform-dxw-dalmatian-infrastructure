locals {
  ...
  infrastructure_ecs_cluster_rsyslog_endpoint                         = local.infrastructure_ecs_cluster_syslog_endpoint != "" ? trimprefix(split(":", local.infrastructure_ecs_cluster_syslog_endpoint)[1], "//") : ""
  ...
  infrastructure_ecs_cluster_user_data = base64encode(
    templatefile("ec2-userdata/ecs-instance.tpl", {
      ...
      syslog_port           = local.infrastructure_ecs_cluster_syslog_port
